...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:template match="eltrun">
		<html>
			<head>
				<title>ELTRUN - phone catalog</title>
				<link href="../images/styles.css" type="text/css" rel="stylesheet" />
				<xsl:comment>Generated by $Id$</xsl:comment>
			</head>
			<body margin-left="0" margin-top="0">
			<div class="logo"><a href="http://www.eltrun.gr/"><img src="../images/eltrun_top1.gif" alt="ELTRUN" align="middle" border="0" /></a> The Research Center
			</div>
			...
			<table class="content">
				...
				<tr>
					...
					<td><xsl:value-of select="current()/email"/></td>
				</tr>
				</xsl:if>				
				</xsl:for-each>
			</table>
